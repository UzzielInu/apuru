...
class HouseHolderSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $householder->nombre = 'Ninfa';$householder->paterno = 'Portilla';$householder->materno = 'Loeza';$householder->extension = '4314';$householder->correo = 'ninfa.portilla@inecol.mx';
      $householder->location_id = '1';
      $householder->save();

      $householder= new HouseHolder;
      $householder->nombre = 'Sandra';$householder->paterno = 'Rocha';$householder->materno = 'Ortíz';$householder->extension = '4353';$householder->correo = 'sandra.rocha@inecol.mx';
      $householder->location_id = '1';
      $householder->save();

      $householder= new HouseHolder;
      $householder->nombre = 'Maria de Lourdes';$householder->paterno = 'Cruz';$householder->materno = 'Huerta';$householder->extension = '4314';$householder->correo = 'lourdes.cruz@inecol.mx';
      $householder->location_id = '1';
      $householder->save();

      $householder= new HouseHolder;
      $householder->nombre = 'Juan Carlos';$householder->paterno = 'Serio';$householder->materno = 'Silva';$householder->extension = '4109';$householder->correo = 'juan.serio@inecol.mx';
      $householder->location_id = '2';
      $householder->save();

      $householder= new HouseHolder;
      $householder->nombre = 'Diego';$householder->paterno = 'Santiago';$householder->materno = 'Alarcón';$householder->extension = '4142';$householder->correo = 'diego.santiago@inecol.mx';
      $householder->location_id = '3';
      $householder->save();

      $householder= new HouseHolder;
      $householder->nombre = 'Maria';$householder->paterno = 'Susana';$householder->materno = 'Barrientos';$householder->extension = '';$householder->correo = 'susana.alvarado@inecol.mx';
