  ...
  <div class="card text-center">
    ...
    <div class="card-body">
      <div class="row justify-content-center my-2">
        ...
        <input type="text" id="marca" name="marca" value="{{$modeldevice->marca}}" class="form-control text-center" placeholder="Marca del Dispositivo">
      </div>
      <div class="row justify-content-center my-2">
        <label for="modelo">Modelo </label>
        <input type="text" id="modelo" name="modelo" value="{{$modeldevice->modelo}}" class="form-control text-center" placeholder="Modelo del Dispositivo">
      </div>
