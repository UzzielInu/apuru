  ...
  <div class="card text-center">
    ...
    <div class="card-body">
      <div class="form-group row justify-content-center my-5">
        ...
        <div class="col-sm-10">
          <input type="text" id="nombre" name="nombre" value="" class="form-control text-center" placeholder="Ejemplo: Problemas de conectividad">
        </div>
      </div>
      <div class="form-group row justify-content-center my-5">
        <label for="descripcion" class="col-sm-2 col-form-label">Descripcion</label>
        <div class="col-sm-10">
          <input type="text" id="descripcion" name="descripcion" value="" class="form-control text-center" placeholder="Ejemplo: Fallas relacionadas con la red">
        </div>
      </div>
      <div class="form-group row justify-content-center my-5">
